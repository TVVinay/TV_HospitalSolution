...
public class Decider {
    ...
    public void getPatientVisitsPercentageInLastThreeDays(){
        ...
        Hospital hospital = new Hospital(Location.Bangalore);
        Patient patient1 = new PatientBuilder().setName("Vinay").setLocation(Location.Mumbai).setDate(currentDate).getPatientBuilder();
        Patient patient2 = new PatientBuilder().setName("Rajesh").setLocation(Location.Bangalore).setDate(currentDate.minusDays(3)).getPatientBuilder();
        Patient patient3 = new PatientBuilder().setName("Raju").setLocation(Location.Mumbai).setDate(currentDate.minusDays(2)).getPatientBuilder();
        Patient patient4 = new PatientBuilder().setName("Sachin").setLocation(Location.Bangalore).setDate(currentDate).getPatientBuilder();
        Patient patient5 = new PatientBuilder().setName("Ravi").setLocation(Location.Pune).setDate(currentDate.minusDays(1)).getPatientBuilder();
